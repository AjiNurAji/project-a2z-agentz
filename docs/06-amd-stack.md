...
| **AMD AI Workbench** | ✅ Used to fine-tune base LLM -> vLLM-served Qwen/Llama-3.1-8B-Instruct-AWQspecialized for Web3 sentiment. GUI no-code, no custom training loop. |
...
Most ACT II submissions will use an out-of-the-box model without fine-tuning. A2Z fine-tunes a base LLM into a Web3-sentiment vLLM-served Qwen/Llama-3.1-8B-Instruct-AWQvia AMD AI Workbench. This:
