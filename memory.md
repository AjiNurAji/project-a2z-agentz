...
- **AI Brain (AMD GPU Server):** vLLM on ROCm serving Qwen/Qwen2.5-72B-Instruct via OpenAI-compatible API
...
- Updated `docs/01-architecture.md` — Added explicit "Active Lane Separation" section documenting:
  - Lane 1: Active Inference Engine (Agent A → Qwen2.5-72B on AMD MI300X via ROCm)
...
|-----------|--------|--------|
| AMD Inference Engine | ✅ Active | vLLM on ROCm, Qwen/Qwen2.5-72B-Instruct, Cloudflare tunnel |
